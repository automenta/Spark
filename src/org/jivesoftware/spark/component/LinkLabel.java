...
/**
 * The <code>LinkLabel</code> class is a JLabel subclass to mimic an html link.
 * When clicked, it launches the specified url in the default browser.
 *
 * @author Derek DeMoro
 */
final public class LinkLabel extends JLabel implements MouseListener {
     ...
     * @param rolloverColor the text color to be used when the mouse is over the
     * label.
     */
