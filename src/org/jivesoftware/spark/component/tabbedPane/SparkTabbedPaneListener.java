...
/**
 * The listener that is notified when state is changed within the
 * <code>SparkTabbedPane</code>
 *
 * @author Derek DeMoro
 */
public interface SparkTabbedPaneListener {
    ...
    /**
     * Implementations of this method allow users to have more fine grained
     * control on closing of individual tabs depending on component state.
     *
     * @param tab the SparkTab that will be closing.
     * @param component the child component of the tab.
     * @return true to allow closing, otherwise returning false will stop
     * closing of this tab.
     */
