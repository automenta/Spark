...
/**
 * Implementations of this interface define native mechanisms based on the
 * Operating System Spark is running on.
 *
 * @author Derek DeMoro
 */
public interface NativeHandler {
    ...
    /**
     * Start the flashing of the given window, but stop flashing when the window
     * takes focus.
     *
