...
/**
 * Interface for all chatroom that get triggered if another chatroom or part of
 * spark changes if the chat frame should always stay on top (Observer Pattern)
 *
