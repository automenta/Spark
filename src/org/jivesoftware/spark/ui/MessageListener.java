 ...
 * <p/>
 * In general, you implement this interface in order to listen for incoming or
 * outgoing messages to particular ChatRooms and to be notified about the
 * message itself.
 */
public interface MessageListener {
    ...
    /**
     * Invoked by the <code>ChatRoom</code> when a new message has been sent.
     *
