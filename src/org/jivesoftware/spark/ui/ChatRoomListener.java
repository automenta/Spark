...
/**
 * The <code>ChatRoomListener</code> interface is one of the interfaces
 * extension writers use to add functionality to Spark.
 * <p/>
 * In general, you implement this interface in order to listen for ChatRoom
 * activity, such as a ChatRoom opening, closing, or being activated.
 */
