...
/**
 * Provides a mechanism for users to register themselves as ChatRoomPlugin
 * objects. This allows users to initialize their own UI's and attach themselves
 * to all ChatRooms for added feature sets.
 */
