 ...
 * <p/>
 * In general, you implement this interface in order to modify the body of the
 * message.
 * <p/>
 * <
 * pre>
 * String currentBody = message.getBody(); currentBody =
 * removeAllBadWords(currentBody); message.setBody(currentBody);
 */
