...
public class ThemePanel extends JPanel {
    ...
    public ThemePanel() {
        ...
        _lookandfeel.addActionListener((ActionEvent e) -> {
        ...
        _lookandfeelpreview.addActionListener((ActionEvent e) -> {
        ...
        _showReconnectBox.addActionListener((ActionEvent e) -> {
...
//        add(new JScrollPane(transcript), new GridBagConstraints(0, 0, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 0, 0));
        ...
        _useTabsForTransports.addActionListener((ActionEvent e) -> {
        ...
        _useTabsForConference.addActionListener((ActionEvent e) -> {
        ...
        if (emoticonManager.getEmoticonPacks() != null) {
            emoticonManager.getEmoticonPacks().stream().forEach((pack) -> {
        ...
        emoticonBox.addActionListener((ActionEvent e) -> {
        ...
        addEmoticonButton.addActionListener((ActionEvent e) -> {
            addEmoticonPack();
        });
    ...
    protected void showSelectedEmoticon() {
        ...
        emoticonManager.getActiveEmoticonSet().stream().map((emoticon) -> new ImageIcon(emoticonManager.getEmoticonURL(emoticon))).map((ico) -> new JLabel(ico)).forEach((label) -> {
            emoticonspanel.add(label);
        });
