...
public class CustomMessages {
    ...
    public static List<CustomStatusItem> load() {
        ...
        Collections.sort(list, (final CustomStatusItem a, final CustomStatusItem b) -> (a.getStatus().compareToIgnoreCase(b.getStatus())));
    ...
    public static void editCustomMessages() {
        ...
        optionPane.addPropertyChangeListener((PropertyChangeEvent propertyChangeEvent) -> {
