...
/**
 * An abstract adapter class for receiving Chat Room Events. The methods in this
 * class are empty. This class exists as convenience for creating listener
 * objects.
 * <p/>
 * Chat Room events let you track when a room is opened, closed, joined, left
 * and activated.
 * <p/>
 * Extend this class to methods for the events of interest. (If you implement
 * the <code>ChatRoomListener</code> interface, you have to define all of the
