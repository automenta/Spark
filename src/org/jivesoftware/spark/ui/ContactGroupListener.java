...
/**
 * The ContactGroupListener interface is one of the interfaces extension writers
 * use to add functionality to Spark.
 * <p/>
 * In general, you implement this interface in order to listen for mouse and key
 * events on <code>ContactGroup</code>s within the Spark client
 * <code>ContactList</code>.
 */
public interface ContactGroupListener {

    /**
     * Notifies a user that a new <code>ContactItem</code> has been added to the
     * ContactGroup.
     *
    ...
    /**
     * Notifies the user that a <code>ContactItem</code> has been removed from a
     * ContactGroup.
     *
    ...
    /**
     * Notifies the user that a ContactItem within the ContactGroup has been
     * double-clicked.
     *
    ...
    /**
     * Notifies the user that a Popup event has occured on the ContactGroup
     * title bar.
     *
     * @param e the MouseEvent that triggered the event.
