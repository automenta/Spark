...
/**
 * The ContactItemHandler allows users to customize the actions that take place
 * within a <code>ContactItem</code> within a users presence changes or the item
 * is double clicked.
 */
