 ...
 * is sent as parameter in every method. Keeping such listener tied to a group
 * chat room instance is wrong because all listeners will be notified when
 * someone joins a particular chat room for example
 */
