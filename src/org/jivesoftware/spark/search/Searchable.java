...
/**
 * Plugin writers will implement <code>Searchable</code> in order to tie into
 * the find feature in Spark.
 */
public interface Searchable {
    ...
    /**
     * Return the text you wish to show in the tooltip when a user hovers over
     * the searchable find field.
     *
    ...
    /**
     * Is called whenver a user does an explict search within Spark. You are
     * responsible for the searching and displaying of the search results.
     *
