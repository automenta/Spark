...
/**
 * Users of the SearchManager can add their own <code>Searchable</code> objects
 * to the Spark search service. This allows for a pluggable search architecture
 * by simply plugging into the find area of the bottom of Spark.
 */
public class SearchManager {
    ...
    /**
     * Returns the singleton instance of <CODE>SearchManager</CODE>, creating it
     * if necessary.
     * <p/>
     *
    ...
    /**
     * Add your own <code>Searchable</code> service.The UI will take immediate
     * effect to indicate that this search service is now available as an
     * option.
     *
    ...
    /**
     * Remove the <code>Searchable</code> service. The UI will take immediate
     * effect to indicate that this search service is no longer an option.
     *
