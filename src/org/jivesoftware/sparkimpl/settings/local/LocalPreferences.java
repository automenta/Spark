...
//	}
    ...
    /**
     * Returns true if it is wanted that a new ad hoc room to be created every
     * time Actions/Start conference room is chosen, or, from a chat window -
     * invite to group chat room icon is pressed. Returns false if it is wanted
     * that the bookmarked room (if any) to be opened every time Actions/Start
     * conference room is chosen, or, from a chat window - invite to group chat
     * room icon is pressed.
     *
     * @param adHocRoom
     * @return
     */
    ...
    /**
     * Set useAdHocRoom on or off. When disabled, if there is at least one
     * bookmark room, that room will be used in Actions/Start conference room
     * Invitation Dialog (instead of creating an ad-hoc room) If there is more
     * than one bookmark room, you can select the bookmarked room that you want
     * to be used Also, when invite to join group chat room will be sent from
     * the chat window, the bookmark room will automatically be opened.
     *
     * @param adHocRoom
     * @return
     */
     ...
     *
     * @param dateIsAsc indicates if the date should be displayed ascending or
     * not
     */
    ...
    /**
     * This will return a {@link Boolean} to indicate if the message-history
     * should display <br>
     * the messages by {@link Date} ascending (<b>true</b>) or descending
     * (<b>false</b>)
     *
     * @return an {@link Boolean} that indicates if the message-history should
     * <br>
    ...
    /**
     * Get the default value for the search period in the history transcript
     * plugin
     *
    ...
    /**
     * Get the defaultVaue for the search period in the history transcript
     * period
     *
