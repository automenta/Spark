...
/**
 * In many cases, you will need to know the structure of the Spark installation,
 * such as the directory structures, what type of system Spark is running on,
 * and also the arguments which were passed into Spark on startup. The
 * <code>Spark</code> class provides some simple static calls to retrieve this
 * information.
 *
...
public final class Spark {
    ...
    /**
     * Private constructor that invokes the LoginDialog and the Spark Main
     * Application.
     */
    public Spark() {
    ...
    /**
     * Returns the value associated with a passed in argument. Spark accepts
     * HTTP style attributes to allow for name-value pairing. ex.
     * username=foo&password=pwd. To retrieve the value of username, you would
     * do the following:
     * <pre>
     ...
     * @return the value of the argument. If no argument was found, null will be
     * returned.
     */
    ...
    /**
     * Returns the bin directory of the Spark install. The bin directory
     * contains the startup scripts needed to start Spark.
     *
    ...
    /**
     * Returns the resource directory of the Spark install. The resource
     * directory contains all native libraries needed to run os specific
     * operations, such as tray support. You may place other native libraries
     * within this directory if you wish to have them placed into the
     * system.library.path.
     *
    ...
    /**
     * Returns the log directory. The log directory contains all debugging and
     * error files for Spark.
     *
    ...
    /**
     * Returns the Spark directory for the current user (user.home). The user
     * home is where all user specific files are placed to run Spark within a
     * multi-user system.
     *
    ...
    /**
     * Loads the language set by the user. If no language is set, then the
