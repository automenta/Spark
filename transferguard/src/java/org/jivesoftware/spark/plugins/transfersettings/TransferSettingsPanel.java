...
/**
 * UI for the file transfer preferences. It displays all the various preference
...
public class TransferSettingsPanel extends JPanel {
    ...
    /**
     * Populates all the gui controls with values from the supplied
     * {@link FileTransferSettings}.
     *
     * @param settings the {@link FileTransferSettings} to populate the gui
     * from.
     */
    ...
    /**
     * Populates the supplied {@link FileTransferSettings} from the values in
     * the gui controls.
     *
