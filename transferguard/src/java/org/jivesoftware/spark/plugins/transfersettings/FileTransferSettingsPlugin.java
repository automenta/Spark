...
/**
 * Spark plugin which allows configuration of allowed file sizes, types, and
 * senders for file transfer. Transfer requests which don't meet the configured
 * preferences are automatically rejecte.
 */
public class FileTransferSettingsPlugin implements Plugin {
    ...
    /**
     * Tests the supplied {@link FileTransferRequest} against the supplied
     * {@link FileTransferSettings}. Returns true if the request fails to match
     * the configuration for allowed files.
     *
     * @param request the transfer request to test.
     * @param settings the transfer settings to use in testing the request.
     * @return true if the request fails to match the configuration for allowed
     * files.
     */
    ...
    /**
     * Strips the extension off the supplied filename and prepends an asterisk.
    ...
    /**
     * Trims the resource off the end of the supplied JID. For example,
     * 'dude@jivesoftware.com/spark' would return 'dude@jivesoftware.com'
     *
    ...
    /**
     * Adds a {@link FileTransferListener} to allow this plugin to intercept
     * {@link FileTransferRequest}s.
     */
