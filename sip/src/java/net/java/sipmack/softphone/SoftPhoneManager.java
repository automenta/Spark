 ...
 * <code>SoftPhoneManager</code> class that Manage SIP Stack, Sessions and Calls
...
//    private int lines = 1;
    ...
    /**
     * Returns the singleton instance of <CODE>SoftPhoneManager</CODE>, creating
     * it if necessary.
     * <p/>
     *
...
PhoneManager.setUsingMediaLocator(false);
    ...
    public void handleMute(InterlocutorUI iui, boolean mic) {
        try {
            ...
            if (audioMediaSession != null) {
                audioMediaSession.setTrasmit(mic);
            }
        } catch (Exception e) {
            Log.error("handleHold", e);
        }
    ...
    /**
     * Returns the state of a <code>Component</code>. If no call is taking
     * place, this method will return null.
     *
