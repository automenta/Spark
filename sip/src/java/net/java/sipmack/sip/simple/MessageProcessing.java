...
public class MessageProcessing {
     ...
     * @param messageBody the message to be sent. The messageBody will be the
     * body of the MESSAGE request to be sent and its format must conform to the
     * values in the parameters contentType and contentEncoding. Please refer to
     * the setBody method for details.
     * @param contentType the Internet media type of the messageBody. Please
     * refer to the Message.setBody method for details.
     * @param contentEncoding the encodings that have been applied to the
     * messageBody in addition to those specified by contentType. Please refer
     * to the Message.setBody method for details.
