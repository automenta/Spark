...
public class SipManager implements SipListener {
     ...
     * specified by <code>callee</code> setting sdpContent as message body. The
     * method generates a Call object that will represent the resulting call and
     * will be used for later references to the same call.
     *
     ...
     * @throws CommunicationsException if an exception occurs while invoking
     * this method.
     */
