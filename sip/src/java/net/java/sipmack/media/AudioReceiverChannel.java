...
/**
 * An Easy to use Audio Channel implemented using JMF. It sends and receives jmf
 * for and from desired IPs and ports. Also has a rport Symetric behavior for
 * better NAT Traversal. It send data from a defined port and receive data in
 * the same port, making NAT binds easier.
 * <p/>
 ...
 * <p/>
 * <i>Transmit and Receive are interdependents. To receive you MUST trasmit.
 * </i>
 *
