...
/**
 * This Class implements a complete JingleMediaSession. It sould be used to
 * transmit and receive audio captured from the Mic. This Class should be
 * automaticly controlled by JingleSession. But you could also use in any VOIP
 * application. For better NAT Traversal support this implementation don't
 * support only receive or only transmit. To receive you MUST transmit. So the
 * only implemented and functionally methods are startTransmit() and
 * stopTransmit()
 *
...
public class AudioMediaSession {
    ...
    /**
     * Creates a AudioMediaSession with defined payload type, remote and local
     * candidates
     *
     * @param audioFormat jmf AudioFormat
     * @param remote The remote information. The candidate that the jmf will be
     * sent to.
     * @param local The local information. The candidate that will receive the
     * jmf
     */
    ...
    /**
     * Closes and finalizes the session. Very important to release static
     * MediaLocator.
     */
    public void close() {
