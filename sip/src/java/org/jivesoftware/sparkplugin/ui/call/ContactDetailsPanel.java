...
/**
 * ContactDetailsPanel handles does a mapping of the phone number with a VCard
 * search on the server. If a JID is found that is associated with this number,
 * the jid will be returned and the VCard information will be displayed.
 */
