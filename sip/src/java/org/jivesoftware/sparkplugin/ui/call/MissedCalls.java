...
/**
 * Responsible for the handling and displaying of missed calls. The toaster
 * should remain visible until the user explicitly closes it.
 *
 * @author Derek DeMoro
 */
public class MissedCalls implements ActionListener {
    ...
    /**
     * Called whenever the user misses a call. The information will be displayed
     * in the Spark Toaster until the user explicitly closes the window.
     *
