...
public class IncomingCall implements JingleSessionListener, ChatRoomClosingListener {
    ...
    /**
     * Returns the <code>JingleSession</code> associated with this incoming
     * call.
     *
     * @return the session.
     */
    ...
    /**
     * Notifies user of an incoming call. The UI allows for users to either
     * accept or reject the incoming session.
     *
