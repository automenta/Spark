...
public class JingleStateManager {
    ...
    /**
     * Returns the singleton instance of <CODE>JingleManager</CODE>, creating it
     * if necessary.
     * <p/>
     *
    ...
    /**
     * Returns the jingle state of a <code>ChatRoom</code>. If no jingle session
     * is taking place, this method will return null.
     *
